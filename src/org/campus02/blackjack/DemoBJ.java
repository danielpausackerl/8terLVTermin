...
public class DemoBJ {
	...
	public static void main(String[] args) {
		...
		Integer value = 11;
		System.out.println("add card value " + value + " for " + p1 + "? " + bj.addCard(p1, value));

		value = 20;
		System.out.println("add card value " + value + " for " + p2 + "? " + bj.addCard(p2, value));

		// try to add card value for "unknown" player 3
		value = 100;
		System.out.println("add card value " + value + " for " + p3 + "? " + bj.addCard(p3, value));
